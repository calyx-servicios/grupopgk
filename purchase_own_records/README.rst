====================
Purchase Own Records
====================

.. !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! This module adds a permission for only current !!
   !! users to view records.                         !!
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
* Find module "purchase_own_records" > Press Install

* Go to Settings > User > Permission > and add the new permission.
