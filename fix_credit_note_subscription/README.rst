============================
Fix Credit Note Subscription
============================

.. !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! TThis module show fields date on account_move. !!
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
|badge1| |badge2| |badge3|
    ...
    This module fix when is created a credit note with subscription.
...
* Find module "fix_credit_note_subscription" > Press Install

* Go to Invoice > and creates a credit note on a subscription invoice.
