========================
Fix Web Services de AFIP
========================

.. !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! This module fixes the python library in the    !!
   !! webservice localization argentina.             !!
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
|badge1| |badge2| |badge3|
    ...
    This module fixes the python library in the webservice localization argentina
...
* Find module "l10n_ar_afipws_decode" > Press Install

* Go to Settings > AFIP certificates > and and save the certificate.
