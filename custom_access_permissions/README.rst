...
.. !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! This module add custom permission and access   !!
   !! rule for invoices and sale order.              !!
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
This module add custom permission and access rule for invoices and sale order.
...
* Find module "custom_access_permissions" > Press Install

* Go to Groups > and add user with this permission.
