========================
Sale Order Date of issue
========================

.. !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !!  This module adds new field on form and tree   !! 
   !! view for date of issue with filters.           !!
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
* Find module "sale_oder_date_issue" > Press Install

* Go to Sale Order > and create a new field.
