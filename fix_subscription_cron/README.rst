=====================
Fix Subscription Cron
=====================

.. !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! This module fixes the schedule action and adds !!
   !! a button to execute it manually.               !!
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
* Find module "fix_subscription_cron" > Press Install

* Go to Subscription > and see the modifications
