========================
Button Create Sale Order
========================

.. !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! This module fixes the subscriptions button     !!
...
|badge1| |badge2| |badge3|
    ...
    This module fixes the subscriptions button to create sales order.
...
* Find module "subscriptions_button" > Press Install

* Go to Subscriptions >  and see the modifications.
