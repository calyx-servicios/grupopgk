    ...
    def create(self, vals_list):
        for vals in vals_list:
            if vals.get('timesheet_id', False):
                ...
                vals['employee_id'] = timesheet_id.employee_id.id if timesheet_id.employee_id else False
                vals['user_id'] = timesheet_id.employee_id.user_id.id if timesheet_id.employee_id and timesheet_id.employee_id.user_id else False
