...
.. |badge2| image:: https://img.shields.io/badge/licence-AGPL--3-blue.png
    ...
    :alt: License: AGPL-3
.. |badge3| image:: https://img.shields.io/badge/github-calyx--servicios%2Fbackend--telecom-lightgray.png?logo=github
    :target: https://github.com/calyx-servicios/backend-telecom.git
    :alt: calyx-servicios/backend-telecom.git
...
This module is part of the `backend-telecom <https://github.com/calyx-servicios/backend-telecom.git>`_ project on GitHub.
