============================
Journal Field Without Domain
============================

.. !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! This module removes the filter in the journal  !!
...
This module removes the filter in the journal in the Journal Entries.
...
* Find module "journal_field_without_domain" > Press Install

* Go to Journal Entries > and see the modifications.
