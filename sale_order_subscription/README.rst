========================
Sale Order Subscriptions
========================

.. !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! This module adds the function of creating a    !! 
   !! subscription from Sale Orders                  !!
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
* Find module "sale_oder_subscription" > Press Install

* Go to Sale Order > and create a sales order with the product that has the subscription enabled.
