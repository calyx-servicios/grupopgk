...
.. !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! This module adds the calculation of the labor  !!
...
This module adds the calculation of the labor cost for each employee.
...
* Find module "labor_cost_employee" > Press Install

* Go to Employees > Labor cost > and see the modifications
