==========================
Calendar View on Timesheet
==========================

.. !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! This module add a new model with holiday with  !!
   !! calendar view on timesheets config.            !!
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
* Find module "calendar_view_timesheet" > Press Install

* Go to timesheets > Settings > Holidays.
* You can see the new module with calendar, form and tree view.
