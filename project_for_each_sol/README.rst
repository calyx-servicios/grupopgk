================================
Project for each Sale Order Line
================================

.. !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! This module adds the functionality of creating !!
   !! a project for each sales order line based on   !!
   !! the type of product.                           !!
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
* Find module "project_for_each_sol" > Press Install

* Go to Sale > Create or modified a new sale order > and see the modifications
