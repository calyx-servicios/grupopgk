========================
Sale Subscription Fields
========================

.. !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! This module transfers key fields from Sales Orders    !! 
   !! to Subscriptions and Invoices, improving subscription !!
...
* Find module "sale_subscriptin_custom_field" > Press Install

* Go to Sale Order > and create a sales order with services.
