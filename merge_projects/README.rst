...
.. !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! This module allows you to merge several projects  !!
   !! into one for the same clients.                    !!
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
* Find module "merge_projects" > Press Install

* Go to Projects >  select record and select the new action.
